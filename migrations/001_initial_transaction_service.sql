...
CREATE INDEX IF NOT EXISTS idx_transactions_sender_receiver 
    ON transactions(sender_user_id, receiver_user_id);
...
-- Constraint para garantir que entity_id referencie transactions apenas quando entity = 'Transaction'
-- Nota: A foreign key é opcional pois audit_logs pode registrar ações de outras entidades
-- A validação de que entity_id só referencia transactions quando entity = 'Transaction' 
